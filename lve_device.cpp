...
//  extensions.push_back(VkPorta); //anton
  return extensions;
}
...
//todo investigate if size == memReq.size
  ...
  std::cout << "buffer requested size : " << size;
  std::cout << "mem req size : " << memRequirements.size;

  std::runtime_error("end");
